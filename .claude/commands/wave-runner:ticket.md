...
Load the ticket-executor agent from `.claude/plugins/wave-runner/agents/ticket-executor.md`.
The agent uses skills from:
- `.claude/plugins/wave-runner/skills/ticket-protocol/SKILL.md`
- `.claude/plugins/wave-runner/skills/gate-conventions/SKILL.md`
